...
void ncoll_high( int nEvts = 100000, string suffix = "_nominal", string ncp = "hNCollNPart" ){
	...
	StCentrality * cen 			= new StCentrality( "auau_14gev", "high");

	// open the file containing the ncol vs. npart distribution
	TFile * fcp 		= new TFile( "hNCollNPart_nominal.root", "READ" );
