...
//  leg->SetBorderSize(1);
  ...
  c1->Print(Form("systematicerror_%s.eps", mName.Data()));
//  c1->Print(Form("%s_systematic_error.png", mName.Data()));
  ...
  c2->Print(Form("%s_vs_centrality_with_systematicerror.eps", mName.Data()));
  ...
  c3->Print(Form("%s_vs_centrality_with_systematicerror.png", mName.Data()));
