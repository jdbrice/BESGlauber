/******************************************************************************
 * $Id: StNbdFitMaker.cxx,v 1.2 2012/04/25 05:15:30 hmasui Exp $
 * $Log: StNbdFitMaker.cxx,v $
...
StNbdFitMaker::StNbdFitMaker()
{
  ...
  mMinimumMultiplicityCut = 50.0 ; // >50 by default. Can be changed by setMinimumMultiplicityCut(const Double_t)
...
//  }
  ...
  mhChi2NDF = new TH1D( "hChi2NDF", "chi2/ndf", 1, 0, 1 );
...
TGraph* StNbdFitMaker::Fit(const Int_t nevents, const Char_t* outputFileName)
{
  ...
  mhChi2NDF->SetBinContent( 1, chi2/(mNData-2.0) );
