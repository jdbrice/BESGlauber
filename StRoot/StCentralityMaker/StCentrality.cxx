  ...
  : mType(type), mNpp(0.0), mK(0.0), mX(0.0)
{
  ...
  else if( system.CompareTo("auau_14gev", TString::kIgnoreCase) == 0 )  Init_AuAu14GeV() ;
...
void StCentrality::Init_AuAu200GeV()
{
  ...
  const Double_t npp = 2.43 ; // default npp
...
void StCentrality::Init_AuAu14GeV()
{

  cout << "DANIEL ADDED THIS CODE" << endl;
  /// Initialize Au + Au collisiona at 14.5 GeV
  ...
  /************************************************************************************/
  // VPD_MB || BBC_MB
  // const Double_t npp = 1.12 ;
  // mNpp = npp + GetNppError(npp) ;
  // mK   = 2.50 ;
  // mX   = 0.12 + xError ;
  // mEfficiency  = 0.94 ; // not mult dependent
  // mTriggerBias = 1.00 ;
  // VPD_MB || BBC_MB
  /************************************************************************************/
  ...
  // BBC_MB ONLY
  /*
  mMultiplicityCut[0].push_back( 239 ); mCentralityMin[0].push_back( 0.0 ); mCentralityMax[0].push_back( 5.0 );
  mMultiplicityCut[0].push_back( 200 ); mCentralityMin[0].push_back( 5.0 ); mCentralityMax[0].push_back( 10.0 );
  mMultiplicityCut[0].push_back( 166 ); mCentralityMin[0].push_back( 10.0 ); mCentralityMax[0].push_back( 15.0 );
  mMultiplicityCut[0].push_back( 138 ); mCentralityMin[0].push_back( 15.0 ); mCentralityMax[0].push_back( 20.0 );
  mMultiplicityCut[0].push_back( 113 ); mCentralityMin[0].push_back( 20.0 ); mCentralityMax[0].push_back( 25.0 );
  mMultiplicityCut[0].push_back(  93 ); mCentralityMin[0].push_back( 25.0 ); mCentralityMax[0].push_back( 30.0 );
  mMultiplicityCut[0].push_back(  75 ); mCentralityMin[0].push_back( 30.0 ); mCentralityMax[0].push_back( 35.0 );
  mMultiplicityCut[0].push_back(  59 ); mCentralityMin[0].push_back( 35.0 ); mCentralityMax[0].push_back( 40.0 );
  mMultiplicityCut[0].push_back(  47 ); mCentralityMin[0].push_back( 40.0 ); mCentralityMax[0].push_back( 45.0 );
  ...
  mMultiplicityCut[1].push_back( 242 );  mMultiplicityCut[2].push_back( 237 );
  mMultiplicityCut[1].push_back( 203 );  mMultiplicityCut[2].push_back( 196 );
  mMultiplicityCut[1].push_back( 171 );  mMultiplicityCut[2].push_back( 162 );
  mMultiplicityCut[1].push_back( 143 );  mMultiplicityCut[2].push_back( 133 );
  mMultiplicityCut[1].push_back( 119 );  mMultiplicityCut[2].push_back( 108 );
  mMultiplicityCut[1].push_back(  98 );  mMultiplicityCut[2].push_back(  87 );
  mMultiplicityCut[1].push_back(  81 );  mMultiplicityCut[2].push_back(  69 );
  mMultiplicityCut[1].push_back(  65 );  mMultiplicityCut[2].push_back(  54 );
  mMultiplicityCut[1].push_back(  52 );  mMultiplicityCut[2].push_back(  42 );
  mMultiplicityCut[1].push_back(  41 );  mMultiplicityCut[2].push_back(  32 );
...
Double_t StCentrality::GetReweighting(const UInt_t multiplicity) const
{
  ...
  const Double_t x[] = {(Double_t)multiplicity};
